...
const EditModal = ({className, name, title, description}) => {
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button
          className={clsx(
            `inline-flex h-[35px] bg-[var(--btn-primary)] items-center justify-center rounded bg-violet4 px-[15px] font-medium leading-none text-violet11 outline-none outline-offset-1 hover:bg-mauve3 focus-visible:outline-2 focus-visible:outline-violet6 select-none ${className}`
          )}
        >
          {name}
        </button>
